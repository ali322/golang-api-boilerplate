...
type User struct {
	...
	IsActived     bool           `gorm:"type:boolean;default:true" binding:"-" json:"is_actived"`
...
func (user User) Update(values interface{}) (User, error) {
	err := db.Model(&user).Updates(values).Error
	return user, err
}
